...
import static org.everit.osgi.cache.infinispan.internal.jcache.RIMBeanServerRegistrationUtility.ObjectNameType.CONFIGURATION;
import static org.everit.osgi.cache.infinispan.internal.jcache.RIMBeanServerRegistrationUtility.ObjectNameType.STATISTICS;
...
import org.everit.osgi.cache.infinispan.internal.jcache.interceptor.ExpirationTrackingInterceptor;
...
public final class JCache<K, V> implements Cache<K, V> {
   ...
   public JCache(AdvancedCache<K, V> cache, Configuration<K, V> c) {
      this.cache = cache;
   ...
   public CacheManager getCacheManager() {
       throw new UnsupportedOperationException("Usage of cache manager is not supported in OSGi environment");
   }
