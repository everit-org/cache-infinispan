...
{
    @Reference(target = "(" + CacheFactoryConstants.GLOBAL_JMX_STATISTICS__ENABLED + "=true)")
    private CacheFactory jmxCacheFactory;

    @Reference(target = "(" + CacheConfigurationConstants.CACHE_NAME + "=simpleCache)")
    private CacheConfiguration<String, String> simpleCacheConfiguration;

    @Reference(target = "(" + CacheFactoryConstants.GLOBAL_JMX_STATISTICS__ENABLED + "=false)")
    private CacheFactory simpleCacheFactory;

    @Reference
    private TransactionHelper t;

    @Reference(target = "(" + CacheConfigurationConstants.CACHE_NAME + "=transactionalCache)")
